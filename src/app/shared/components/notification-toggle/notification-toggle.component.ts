  ...
  template: `
    <div class="relative">
      ...
      >
        ...
        <span *ngIf="showDot" class="absolute top-1 right-1 h-2 w-2 bg-red-500 rounded-full"></span>
      </button>
      
      <!-- Dropdown menu -->
      <div *ngIf="showMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50">
        ...
        <div class="px-4 py-2">
          <label class="flex items-center space-x-2 cursor-pointer">
            ...
            >
            <span class="text-sm text-gray-700">{{ isEnabled ? 'Disable' : 'Enable' }} notifications</span>
          </label>
        </div>
      </div>
    </div>
